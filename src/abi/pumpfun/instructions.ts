import {struct, u64, address, bool, i64, unit, string} from '@subsquid/borsh'
import {instruction} from '../abi.support'

/**
 * Placeholder docs.
 */
export interface TradeEventInstruction {
    padding0: bigint
    padding1: bigint
    mint: string
    solAmount: bigint
...
export const tradeEventInstruction = instruction(
    ...
    {
        whoKnowsWhatThisAccountIsButItsInTheExplorerSoGuessIllAddIt: 0,
    },
    struct({
        padding0: u64,
        padding1: u64,
